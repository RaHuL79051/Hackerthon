    ...
    <header class="main-header">
      ...
      <nav class="navbar">
        <ul>
          ...
          <li><a href="./modules/distance_module/distance.php">Distance</a></li>
          <li><a href="./modules/bugdet_Module/budget.php">Budget</a></li>
          <li><a href="./modules/todo_module/todo.php">To-Do</a></li>
          <li><a href="./dashboard.php?show=chatbot">Chatbot</a></li>
